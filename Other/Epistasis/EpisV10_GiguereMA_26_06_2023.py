...
def Epistasis(condition):
    ...
    # Dataframe of every single mutation.
    SingleMutations = ShortData[ShortData['Nmut_codons'] == 1.0]

    # Dataframe of every ortholog sequence
    ...
    # Create lists for the dataframe needed to make the graphs.
    AdditivityScore = []
    OrthologScore = []
    ListLocus = []
    ListCompound = []

    # List of all Ortholog Hotspot Sequences
