...
# Optimisation par la selection des meilleurs parametres.
#X = X[['aa_pos', 'beta_sheet_levitt', 'retention_coefficient_tfa_browne', 'hydrophobicity_tanford', 'percentage_accessible_residues_janin']]
