...
# {'max_depth': 7, 'max_features': None, 'n_estimators': 900, 'random_state': 18}
#RandomForest r2 score :  0.5770182313905303
#RandomForest MSE :  0.2792425902092098
#RandomForest MAE :  0.4204058924515873

# CASPO {'max_depth': 8, 'max_features': None, 'n_estimators': 900, 'random_state': 18}
#RandomForest r2 score :  0.5785165295469608
#RandomForest MSE :  0.27825344909449273
#RandomForest MAE :  0.41477719933575075

# ANI {'max_depth': None, 'max_features': None, 'n_estimators': 900, 'random_state': 18}
#RandomForest r2 score :  0.5085888034154619
#RandomForest MSE :  0.3780621853857608
#RandomForest MAE :  0.49092889527587097

# MICA {'max_depth': 10, 'max_features': None, 'n_estimators': 1000, 'random_state': 18}
...
feat_importances2 = pd.Series(importance, index=X_train.columns)
