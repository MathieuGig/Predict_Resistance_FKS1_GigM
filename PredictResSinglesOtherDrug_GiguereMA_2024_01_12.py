...
Drug1_master[['aa0', 'aa1', 'aa2', 'aa3', 'aa4', 'aa5', 'aa6', 'aa7', 'aa8']] = Drug1_master['aa_seq'].apply(lambda x: pd.Series(list(x)))

Drug1_merged = pd.merge(left=Drug1_master, right=AAproperties, how='inner', indicator=False, suffixes=(None, '_aa0'),
                  on='aa0')
...
X_train = Drug1_merged.drop(columns=['strain', 'locus', 'seq_type', 'aa_seq', 'pool_type', 'compound', 'median_s',
                                     'Nham_aa', 'alt_aa', 'Resistance',
                                      'aa_pos', 'aa0', 'aa1', 'aa2', 'aa3', 'aa4', 'aa5', 'aa6', 'aa7', 'aa8'])
...
Drug2_master[['aa0', 'aa1', 'aa2', 'aa3', 'aa4', 'aa5', 'aa6', 'aa7', 'aa8']] = Drug2_master['aa_seq'].apply(lambda x: pd.Series(list(x)))

AAproperties.rename(columns={'aa8': 'aa0'}, inplace=True)
Drug2_merged = pd.merge(left=Drug2_master, right=AAproperties, how='inner', indicator=False, suffixes=(None, '_aa0'),
                  on='aa0')
...
X_test = Drug2_merged.drop(columns=['strain', 'locus', 'seq_type', 'aa_seq', 'pool_type', 'compound',
                                    'aa_pos', 'alt_aa', 'median_s', 'Nham_aa', 'Resistance',
...
sns.heatmap(cmatrix, annot=True, fmt='d', cmap='Blues',
            ...
            yticklabels=['resistant', 'susceptible'], annot_kws={"size": 60})
