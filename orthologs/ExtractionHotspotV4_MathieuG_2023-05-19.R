...
ExtractionHotspot <- function(fichierAlignements)
{
    ...
    ## Ajouter des colonnes qui indiquent la présence de gaps dans les hotspots
    ...
    # Importation des fichiers des hotspots uniques représentant les oligos
    ...
    if (grepl("FKS1", fichierAlignements))
    {
        # Pour chaque séquence de hotspot dans le data frame, regarde si elle
        # est présente dans les séquences utilisées pour les oligos.
