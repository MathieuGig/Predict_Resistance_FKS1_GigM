...
grid = {
    'n_estimators': [400, 500, 550, 600, 700, 900],
...
#print('start')
#CV_rf = GridSearchCV(estimator=RandomForestRegressor(), param_grid=grid)
#CV_rf.fit(X_train_s, y_train)
#print('end')
#print(CV_rf.best_params_)
#print(CV_rf.best_score_)

# {'max_depth': None, 'max_features': None, 'n_estimators': 400, 'random_state': None}
# {'max_depth': None, 'max_features': None, 'n_estimators': 500, 'random_state': 18}
rf = RandomForestRegressor(n_estimators=500, max_features=None, max_depth=None, random_state=18)
